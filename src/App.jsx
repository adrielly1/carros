    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-orange">Ver mais</a>
        </div>
        <div className="bg-green p-12">
          ...
          target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-green">Ver mais</a>
        </div>
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-dark-green">Ver mais</a>
        </div>
      </section>
    </main>
  )
